        ...
        <div class="bg-white py-6 sm:py-8 lg:py-12">
          <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div class="mb-10 md:mb-16 text-center">
              <h2 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">WebSite</h2>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
              <Link to="/works-web-06" className="gradient-wrap bg-blue-100 group relative flex h-48 items-end justify-end overflow-hidden rounded-lg shadow-lg md:h-96">
                <div class="absolute inset-0 h-full w-full">
                    <StaticImage src="../images/works/mic/mock/001.png" placeholder="none" alt="MICWARE CO., LTD." class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                </div>
              ...
              <Link to="/works-web-04" className="gradient-wrap bg-lime-100 group relative flex h-48 items-end justify-end overflow-hidden rounded-lg shadow-lg md:h-96">
                <div class="absolute inset-0 h-full w-full">
                    <StaticImage src="../images/works/ai/mock/001.png" placeholder="none" alt="Ai-MetaRoom" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                </div>
                ...
                <span class="relative mr-3 mb-3 inline-block rounded-lg border border-white px-2 py-1 text-xs text-gray-200 backdrop-blur md:px-3 md:text-sm">Landing</span>
              </Link>
              ...
              <Link to="/works-web-03" className="gradient-wrap group relative flex h-48 items-end justify-end overflow-hidden rounded-lg shadow-lg md:h-96">
                <div class="absolute inset-0 h-full w-full">
                    <StaticImage src="../images/works/artiststore/mock/001.png" placeholder="none" alt="ARTISTSTORE.JP" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                </div>
              ...
              <Link to="/works-web-02" className="gradient-wrap bg-rose-100 group relative flex h-48 items-end justify-end overflow-hidden rounded-lg shadow-lg md:h-96">
                <div class="absolute inset-0 h-full w-full">
                    <StaticImage src="../images/works/2nd/mock/001.png" placeholder="none" alt="2nd Kitchen" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                </div>
              ...
              <Link to="/works-web-01" className="gradient-wrap bg-pink-100 group relative flex h-48 items-end justify-end overflow-hidden rounded-lg shadow-lg md:h-96">
                <div class="absolute inset-0 h-full w-full">
                    <StaticImage src="../images/works/woman/mock/001.png" placeholder="none" alt="Womanlife CO., LTD." class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                </div>
              ...
              <Link to="/works-web-00" className="gradient-wrap bg-purple-100 group relative flex h-48 items-end justify-end overflow-hidden rounded-lg shadow-lg md:h-96">
                <div class="absolute inset-0 h-full w-full">
                    <StaticImage src="../images/works/boj/mock/001.png" placeholder="none" alt="BALLET OFFICE JAPAN" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                </div>
